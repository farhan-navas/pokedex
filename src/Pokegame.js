    ...
    render() {
        ...
        return (
            <div className="Pokegame">
                <div><Pokedex pokemon={hand1} exp={hand1Exp} isWinner={hand1Exp > hand2Exp}/></div>
                <div><Pokedex pokemon={hand2} exp={hand2Exp} isWinner={hand2Exp > hand1Exp}/></div>
            </div>
        )
    }
}
